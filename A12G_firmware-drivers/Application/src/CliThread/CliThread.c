...
static const CLI_Command_Definition_t xGetIMUDataCommand = {"imu", "imu: Prints 1000 samples of acceleration. \r\n", (const pdCOMMAND_LINE_CALLBACK)CLI_IMU_data, 0};
static const CLI_Command_Definition_t xGetHapticCommand = {"haptic", "haptic: Vibrate Motor. \r\n", (const pdCOMMAND_LINE_CALLBACK)CLI_Haptic, 0};
static const CLI_Command_Definition_t xSetLEDCommand = {"led", "led: Set LED Strip color\r\n", (const pdCOMMAND_LINE_CALLBACK)CLI_LED, 0};
static const CLI_Command_Definition_t xSetIRSensorCommand = {"ir", "ir: Detect Object\r\n", (const pdCOMMAND_LINE_CALLBACK)CLI_IR, 0};
...
/**
 * @brief    Scans for connected i2c devices
 * @param    p_cli
 * @param    argc
 * @param    argv
 ******************************************************************************/
