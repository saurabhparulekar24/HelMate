...
#ifndef SECRET_H_
#define MAIN_WLAN_SSID "Saurabh"           /**< Destination SSID. Change to your WIFI SSID */
#define MAIN_WLAN_AUTH M2M_WIFI_SEC_WPA_PSK /**< Security manner */
#define MAIN_WLAN_PSK "amogh123"      /**< Password for Destination SSID. Change to your password. Please dont hack my WiFi router */
#endif                                      /* SECRET_H_ */
...
#define MAIN_HTTP_FILE_URL "http://52.242.73.67/TestA.bin"  ///< Change me to the URL to download your OTAU binary file from!
...
// Cloud MQTT PASSWORD
#define CLOUDMQTT_USER_PASSWORD "Changping12@"
 ...
 */
// http://52.242.73.67/
static const char main_mqtt_broker[] = "52.242.73.67"; 
